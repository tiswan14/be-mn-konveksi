/*
  ...
  - The values [MENUNGGU_PELUNASAN] on the enum `StatusPesanan` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "StatusPesanan_new" AS ENUM ('MENUNGGU_DP', 'DIPROSES', 'SELESAI', 'DIBATALKAN');
