/*
  ...
  - The values [DIBUAT] on the enum `StatusPesanan` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "StatusPesanan_new" AS ENUM ('MENUNGGU_DP', 'DIPROSES', 'MENUNGGU_PELUNASAN', 'SELESAI', 'DIBATALKAN');
