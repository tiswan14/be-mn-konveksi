/*
  ...
  - The values [MENUNGGU_DP] on the enum `StatusPesanan` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "StatusPesanan_new" AS ENUM ('MENUNGGU_PEMBAYARAN', 'DIPROSES', 'SELESAI', 'DIBATALKAN');
...
ALTER TABLE "Pesanan" ALTER COLUMN "status_pesanan" SET DEFAULT 'MENUNGGU_PEMBAYARAN';
COMMIT;
